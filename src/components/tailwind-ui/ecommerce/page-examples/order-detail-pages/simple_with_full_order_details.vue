  ...
  <main class="bg-white px-4 pt-16 pb-24 sm:px-6 sm:pt-24 lg:px-8 lg:py-32">
    <div class="max-w-3xl mx-auto">
      <div class="max-w-xl">
        ...
        <p class="mt-2 text-4xl font-bold tracking-tight sm:tracking-tight">It's on the way!</p>
      ...
      <section aria-labelledby="order-heading" class="mt-10 border-t border-gray-200">
        ...
        <div v-for="product in products" :key="product.id" class="py-10 border-b border-gray-200 flex space-x-6">
          <img :src="product.imageSrc" :alt="product.imageAlt" class="flex-none w-20 h-20 object-center object-cover bg-gray-100 rounded-lg sm:w-40 sm:h-40" />
