      ...
      <div class="relative overflow-hidden">
        ...
        <section aria-labelledby="sale-heading" class="relative max-w-7xl mx-auto pt-32 px-4 flex flex-col items-center text-center sm:px-6 lg:px-8">
          <div class="max-w-2xl mx-auto lg:max-w-none">
            <h2 id="sale-heading" class="text-4xl font-bold tracking-tight text-gray-900 sm:tracking-tight sm:text-5xl lg:tracking-tight lg:text-6xl">Get 25% off during our one-time sale</h2>
