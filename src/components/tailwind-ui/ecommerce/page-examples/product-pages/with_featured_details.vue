      ...
      <div class="bg-white">
        <div class="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:pt-24 sm:pb-32 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-x-8">
          ...
          <div class="lg:max-w-lg lg:self-end">
            ...
            <div class="mt-4">
              <h1 class="text-3xl font-bold tracking-tight text-gray-900 sm:tracking-tight sm:text-4xl">{{ product.name }}</h1>
            </div>
      ...
      <div class="max-w-2xl mx-auto px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
        ...
        <section aria-labelledby="details-heading">
          <div class="flex flex-col items-center text-center">
            <h2 id="details-heading" class="text-3xl font-bold tracking-tight text-gray-900 sm:tracking-tight sm:text-4xl">The Fine Details</h2>
