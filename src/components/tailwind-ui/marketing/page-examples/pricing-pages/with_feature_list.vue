...
<template>
  <div class="bg-white">
        ...
        <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
          <div class="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              ...
              <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark.svg?color=blue&shade=600" alt="" />
            </a>
          </div>
          ...
          <div class="hidden md:flex items-center justify-end space-x-8 md:flex-1 lg:w-0">
            ...
            <a href="#" class="whitespace-nowrap bg-blue-100 border border-transparent rounded-md py-2 px-4 inline-flex items-center justify-center text-base font-medium text-blue-700 hover:bg-blue-200"> Sign up </a>
          </div>
        </div>
      </div>
    ...
    <div class="bg-gradient-to-b from-blue-50 via-white to-white">
      ...
      <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <div class="pb-16 xl:flex xl:items-center xl:justify-between">
          <div>
            <h1 class="text-4xl tracking-tight font-bold sm:text-5xl sm:tracking-tight">
        ...
        <div class="border-t border-gray-200 pt-16 xl:grid xl:grid-cols-3 xl:gap-x-8">
          <div>
            ...
            <p class="mt-2 text-3xl tracking-tight font-bold text-gray-900">All-in-one platform</p>
    ...
    <div class="bg-blue-900">
      <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        <h2 class="text-3xl tracking-tight font-bold text-white">Frequently asked questions</h2>
    ...
    <div class="bg-blue-50">
      <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-24 lg:px-8 lg:flex lg:items-center lg:justify-between">
        <h2 class="text-3xl font-bold tracking-tight text-blue-900 sm:text-4xl sm:tracking-tight">
          <span class="block">Ready to dive in?</span>
          <span class="block text-blue-600">Start your free trial today.</span>
        </h2>
        <div class="mt-8 flex lg:flex-shrink-0 lg:mt-0">
          <div class="inline-flex rounded-md shadow">
            <a href="#" class="bg-blue-600 border border-transparent rounded-md py-3 px-5 inline-flex items-center justify-center text-base font-medium text-white hover:bg-blue-700"> Get started </a>
          </div>
        </div>
      </div>
    </div>
    ...
    <footer class="max-w-7xl mx-auto py-16 px-4 overflow-hidden sm:px-6 lg:px-8">
      ...
      <p class="mt-8 text-center text-base text-gray-500">&copy; 2020 Workflow, Inc. All rights reserved.</p>
    </footer>
  </div>
</template>
