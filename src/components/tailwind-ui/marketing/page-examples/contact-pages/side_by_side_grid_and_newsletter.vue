  ...
  <div class="bg-white">
    <header class="relative pb-24 bg-sky-800 sm:pb-32">
      ...
      <div class="relative mt-24 max-w-md mx-auto px-4 sm:max-w-3xl sm:mt-32 sm:px-6 lg:max-w-7xl lg:px-8">
        <h1 class="text-4xl font-bold tracking-tight text-white sm:text-5xl sm:tracking-tight lg:text-6xl lg:tracking-tight">Get in touch</h1>
      ...
      <div class="bg-warm-gray-50">
        <div class="max-w-md mx-auto py-24 px-4 sm:max-w-3xl sm:py-32 sm:px-6 lg:max-w-7xl lg:px-8">
          <div class="lg:grid lg:grid-cols-3 lg:gap-8">
            <div>
              <h2 class="text-3xl tracking-tight font-bold text-warm-gray-900">Frequently asked questions</h2>
