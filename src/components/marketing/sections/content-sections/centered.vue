  ...
  <div class="relative py-16 bg-white overflow-hidden">
    ...
    <div class="relative px-4 sm:px-6 lg:px-8">
      <div class="text-lg max-w-prose mx-auto">
        <h1>
          <span class="block text-lg text-center text-indigo-600 font-semibold">Introducing</span>
          <span class="mt-2 block text-3xl text-center leading-8 font-bold tracking-tight text-gray-900 sm:text-4xl sm:tracking-tight">JavaScript for Beginners</span>
        </h1>
