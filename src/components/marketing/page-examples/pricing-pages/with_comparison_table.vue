    ...
    <div class="bg-indigo-900">
          ...
          <div class="flex justify-between items-center border-b border-indigo-400 border-opacity-25 py-6 md:justify-start md:space-x-10">
            <div class="flex justify-start lg:w-0 lg:flex-1">
              <a href="#">
                ...
                <img class="h-8 w-auto sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark.svg?from-color=orange&from-shade=400&to-color=pink&to-shade=500&toShade=500" alt="" />
              </a>
            </div>
            ...
            <div class="rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y-2 divide-gray-50">
              <div class="pt-5 pb-6 px-5 space-y-6">
                <div class="flex items-center justify-between">
                  <div>
                    <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-mark.svg?from-color=orange&from-shade=400&to-color=pink&to-shade=500&toShade=500" alt="Workflow" />
                  </div>
                  <div class="-mr-2">
      ...
      <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:max-w-7xl">
        <div class="px-0 sm:px-4 lg:px-0 lg:flex lg:justify-between lg:items-center">
          <div class="max-w-xl">
            <h2 class="text-4xl tracking-tight font-bold text-white sm:text-5xl sm:tracking-tight lg:text-6xl lg:tracking-tight">Pricing Plans</h2>
