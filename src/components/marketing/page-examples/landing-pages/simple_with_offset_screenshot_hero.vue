          ...
          <div>
            ...
            <div class="mt-20">
              ...
              <div class="mt-6 sm:max-w-xl">
                <h1 class="text-4xl font-bold text-gray-900 tracking-tight sm:text-5xl sm:tracking-tight">Issue management for growing teams</h1>
        ...
        <div class="lg:mx-auto lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:gap-24 lg:items-start">
          ...
          <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
            ...
            <div class="pt-12 sm:pt-16 lg:pt-20">
              <h2 class="text-3xl text-gray-900 font-bold tracking-tight sm:text-4xl sm:tracking-tight">On a mission to empower teams</h2>
      ...
      <div class="mt-32">
        <div class="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
          <div class="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
            <div>
              <h2 class="text-3xl font-bold text-gray-900 tracking-tight sm:text-4xl sm:tracking-tight">Backed by world-renowned investors</h2>
